package com.oleg.belov.javase.functional.programming.utils;
...
public class SampleDataUtils {
    ...
    public static final Album sampleShortAlbum = new Album("sample Short Album", asList(new Track("short track", 30)), asList(johnLennon));
    public static final Album manyTrackAlbum = new Album("sample Short Album2", asList(new Track("short track2", 30), new Track("short track 2", 30), new Track("short track 3", 30), new Track("short track 4", 30), new Track("short track 5", 30)), asList(johnColtrane, paulMcCartney));
    public static final Album manyTrackAlbum2 = new Album("sample Short Album3", asList(new Track("short track3", 50), new Track("short track 2", 30), new Track("short track 3", 30), new Track("short track 4", 30), new Track("short track 5", 30)), asList(theBeatles, johnColtrane));
    ...
    public static List<Album> getAllAlbumsList() {
    	return Arrays.asList(aLoveSupreme, sampleShortAlbum, manyTrackAlbum, manyTrackAlbum2);
    }
    
    public static Stream<Album> getAllAlbumsStream() {
    	return Stream.of(aLoveSupreme, sampleShortAlbum, manyTrackAlbum, manyTrackAlbum2);
    }
}
