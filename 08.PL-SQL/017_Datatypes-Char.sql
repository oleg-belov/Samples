...
/*
	l_char_with_space is blank padded and is equal to l_char_without_space
    l_varchar2_without_space is not blank padded and so is not equal to l_char_with_space
*/
