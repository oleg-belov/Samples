...
public class MongoDBRestaurantCollection implements MongoDBCollection {
	...
	public MongoDBRestaurantCollection(String host, String port, String database, String collection, String user, String pws) {
		this.host = host;
		this.port = port;
