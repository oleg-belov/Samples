	...
	public static void main(String[] args) {
      ...
      // log.info("\nAuthor table is deleted!");
       ...
       for(int i = 1; i < 10; i++) {
    	   ...
    	   author.setName("Jhon " + i);
    	   author.setBirthDate(new Date(1991));
    	   
    	   authors.add(author);
       }
       
       int authorsInserted = bLibraryService.insertAuthorsList(authors).length;
       
       log.info("\nAuthors inserted: " + authorsInserted);
       
       int authorsInsertedByPS = bLibraryService.insertAuthorsListByPS(authors).length;
       
       log.info("\nAuthors inserted by  prepared statement: " + authorsInsertedByPS);
	}
}
